function Run_Solve_loadpath3D(dim, sim_dir, seed_dir, save_dir, model_name,path_dir,...
            ...
            switch dim
                ...
                case {'3D'}
                    parfor (i = 1:numSeeds, workers)
                        ...
                        %[x, y, z, intense ] = RunLibrary_rungekuttaNatInter3D(xseed(i), yseed(i),...
                        %    zseed(i), PartArr, path_dir, nodePerEl,path_length, true,step_size, wb);
                         [x, y, z, intense ] = RunLibrary_rungekuttaNatInter3D(xseed(i), yseed(i),...
                            zseed(i), PartArr, path_dir, nodePerEl,path_length, true,step_size, wb,nodes,RN,XC,YC,ZC);                       
            ...
            switch dim
                case {'3D'}
                    ...
                    for i = 1:numSeeds;
                        ...
                        %[x, y, z, intense] = RunLibrary_rungekuttaNatInter3D(xseed(i),...
                        %    yseed(i),zseed(i), PartArr, path_dir, nodePerEl,path_length,false,step_size, wb);      
                        [dkx, dky, dkz, dkintense] = RunLibrary_rungekuttaNatInter3D(xseed(i),...
                            yseed(i),zseed(i), PartArr, path_dir, nodePerEl,path_length,false,step_size, wb,nodes,RN,XC,YC,ZC);              
                        if isempty(dkx)
                            fprintf('Path %i unsuccessful\n',i)
                            continue
                        ...
                        %[x, y, z, intense ] = RunLibrary_rungekuttaNatInter3D(xseed(i), yseed(i),...
                        %    zseed(i), PartArr, path_dir, nodePerEl,path_length,true,step_size, wb);                       
                        [dkx, dky, dkz, dkintense ] = RunLibrary_rungekuttaNatInter3D(xseed(i), yseed(i),...
                            zseed(i), PartArr, path_dir, nodePerEl,path_length,true,step_size, wb,nodes,RN,XC,YC,ZC);                        
